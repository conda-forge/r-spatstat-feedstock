...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-spatstat-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-spatstat-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install r-spatstat
```
...
It is possible to list all of the versions of `r-spatstat` available on your platform:
...
```
pixi search r-spatstat --channel conda-forge
```
